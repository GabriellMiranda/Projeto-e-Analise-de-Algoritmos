...
typedef struct{
    ...
    char *textoDecifrado;//texto que esta parcialmente decifrado
    char *textoCriptografado;//texto criptografado
    char *textoMundanca;//sinaliza a letra que vai ser mudada no texto parcialmente decifrado
    char *textoAntigo;// o caracter da palavra que fou substituida
}ChaveCriptografada;
