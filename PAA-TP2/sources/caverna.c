...
//caminhando de cima para baixo na matriz para se ter o menor caminho
...
//percorrendo o mapa que já foi calculado verificando o menor caminho e printando este caminho
